...
for picker in highlighted_poems_list:
    highlighted_poems_stripped.append(picker.strip())

print(highlighted_poems_stripped)

highlighted_poems_details = []
for picker2 in highlighted_poems_stripped:
  highlighted_poems_details.append(picker2.split(":"))
...
poets = []
dates = []
for runbig in highlighted_poems_details:
    titles.append(runbig[0])
    poets.append(runbig[1])
    dates.append(runbig[2])
# print(titles, poets, dates)

for collector in range(0,len(highlighted_poems_details)):
  print("The poem {} was published by {} in {}.".format(titles[collector],poets[collector],dates[collector] ))
