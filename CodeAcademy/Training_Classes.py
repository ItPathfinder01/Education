...
# Task 3
# class Skill_measurement:
#     def __int__(self, skill_level,sex):
#         self.skill_level= skill_level
#         self.sex= sex
#
#     def check_skill_level(self):
#
#
#
# class Beginner(Skill_measurement):
#
#
# class Intermediate(Skill_measurement):

class Skill_measurement:
    def __init__(self, skill_level, sex):
        self.skill_level = skill_level
        self.sex = sex
...
class Beginner(Skill_measurement):
    def __init__(self, skill_level, sex):
        super().__init__(skill_level, sex)

    def practice(self):
        if self.sex == "man":
            print("Мужчина тренирует beginner-уровень навыков")
        elif self.sex == "woman":
            print("Женщина тренирует beginner-уровень навыков")
        else:
...
class Intermediate(Skill_measurement):
    ...
    def practice(self):
        if self.sex == "man":
            print("Мужчина тренирует intermediate-уровень навыков")
        elif self.sex == "woman":
            print("Женщина тренирует intermediate-уровень навыков")
        else:
            print("Некорректно указан пол")

beginner = Beginner("beginner", "man")
intermediate = Intermediate("intermediate", "woman")

group = [beginner, intermediate]
for human in group:
    human.check_skill_level()
